...
export function BrandsCarousel({ isCollapsed, brandMenuItems, isMobile }: BrandsCarouselProps) {
        ...
        <CarouselContent className="-ml-2 md:-ml-4">
          {brandMenuItems.map((brand, index) => (
            <CarouselItem 
              ...
              className={cn(
                "pl-2 md:pl-4",
                isMobile ? "basis-full sm:basis-1/2" : "basis-full md:basis-1/2 lg:basis-1/3"
              )}
            >
              <motion.button
                ...
                className={cn(
                  "group flex flex-col items-center gap-4 sm:gap-6 rounded-lg overflow-hidden",
              ...
              >
                ...
                <span className={cn(
                  "font-medium bg-gradient-gold bg-clip-text text-transparent group-hover:text-foreground transition-colors duration-300 p-3",
